...
class PDFViewer {
  ...
  // Verifica se as teclas Ctrl + Shift + A foram pressionadas
  if (event.key === 'a') {
    // Alterna o estado do modo de anotação
    if (this.annotationEditorMode !== AnnotationEditorType.INK) {
      // Se estiver desativado, ativa o modo de anotação desejado
      this.annotationEditorMode = {
        mode: AnnotationEditorType.INK, // Ou outro tipo de anotação
        isFromKeyboard: true,
      };
    } else {
  ...
  if (event.key === 'm') {
    // Alterna o estado do modo de anotação
    if (this.annotationEditorMode !== AnnotationEditorType.HIGHLIGHT) {
      // Se estiver desativado, ativa o modo de anotação desejado
      this.annotationEditorMode = {
        mode: AnnotationEditorType.HIGHLIGHT, // Ou outro tipo de anotação
        isFromKeyboard: true,
      };
    } else {
      // Se estiver ativado, desativa
